...
def main():
    ...
    arg_parser = get_transfer_learning_arg_parser()
    ...
    # Retrieve the model that will be used as start to the transfer learning
    ...
    for i, species in enumerate(species_in_region):
        ...
        aucs = evaluate_results(y_test, y_pred, config["species_idx"])
        ...
        if args.save_model_path is not None:
            save_model(fine_tuned_model, args.save_model_path, run_type, region)
